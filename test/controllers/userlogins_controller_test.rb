...
class UserloginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userlogin" do
    assert_difference('Userlogin.count') do
      post userlogins_url, params: { userlogin: { address: @userlogin.address, email: @userlogin.email, mobile: @userlogin.mobile, name: @userlogin.name, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update userlogin" do
    patch userlogin_url(@userlogin), params: { userlogin: { address: @userlogin.address, email: @userlogin.email, mobile: @userlogin.mobile, name: @userlogin.name, password: 'secret', password_confirmation: 'secret' } }
